...
const HeroSection = React.forwardRef<HTMLDivElement, HeroSectionProps>(
  (
    ...
    return (
      <div className={cn("relative overflow-hidden rounded-[40px]", className)} ref={ref} {...props}>
        <div className="absolute top-0 z-[0] h-full w-full bg-indigo-950/5 dark:bg-indigo-950/10 bg-[radial-gradient(ellipse_20%_80%_at_50%_-20%,rgba(120,119,198,0.15),rgba(255,255,255,0))] dark:bg-[radial-gradient(ellipse_20%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]" />
        <section className="relative max-w-full mx-auto z-1">
          <RetroGrid {...gridOptions} />
          <div className="max-w-screen-xl z-10 mx-auto px-4 py-20 gap-12 md:px-8">
            <div className="space-y-5 max-w-3xl leading-0 lg:leading-5 mx-auto text-center">
              ...
              <p className="max-w-2xl mx-auto text-gray-600 dark:text-gray-300 font-medium">
                {description}
              </p>
              <div className="items-center justify-center pt-8">
                <button
                  onClick={onCtaClick}
                  className="btn-3d group inline-flex h-16 items-center justify-center rounded-2xl px-12 py-4 text-sm font-black uppercase tracking-[0.2em] text-white shadow-xl ring-4 ring-indigo-500/20 transition-all active:scale-95"
                >
