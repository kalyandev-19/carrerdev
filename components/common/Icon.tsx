...
const Icon: React.FC<IconProps> = ({ name, className = 'h-6 w-6' }) => {
  const icons: { [key: string]: React.ReactNode } = {
    ...
    roadmap: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 6.75V15m6-10.5v.75m.001 3v.75m0 3v.75m0 3v.75m0 3V18m-6-11.25h.008v.008H9V6.75Zm.008 4.5H9V11.25h.008v.008Zm0 4.5H9V15.75h.008v.008Z" />
      </svg>
    ),
    interview: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
