...
const Icon: React.FC<IconProps> = ({ name, className = 'h-6 w-6' }) => {
  const icons: { [key: string]: React.ReactNode } = {
    ...
    roadmap: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 6.75V15m6-10.5v.75m.001 3v.75m0 3v.75m0 3v.75m0 3v.75m0 3v.75m0 3V18m-6-11.25h.008v.008H9V6.75Zm.008 4.5H9V11.25h.008v.008Zm0 4.5H9V15.75h.008v.008Z" />
      </svg>
    ),
    interview: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    ...
    network: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0a5.995 5.995 0 0 0-4.058-3.136c-1.376-.355-2.803-.355-4.179 0a6.003 6.003 0 0 0-4.058 3.136m0 0c-.61 1.248-.941 2.656-.941 4.197m0 0a5.97 5.97 0 0 0 .941 3.197m0 0a5.995 5.995 0 0 0 4.058 3.136c1.376.355 2.803.355 4.179 0a6.003 6.003 0 0 0 4.058-3.136" />
      </svg>
    ),
    location: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
